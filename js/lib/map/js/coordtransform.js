var Transformation = function(ag1, ag2,zone) {
	...
	this.cps = [/*{sp:{x:7665927.7654916,y:4655360.3929787},tp:{x:108.70222963693,y:34.315080799379}},
	            ...
	            {sp:{x:211897.36200,y:291449.66800},tp:{x:107.89059,y:32.53903}},
				{sp:{x:211274.05400,y:290154.19600},tp:{x:107.89827,y:32.52398}},
				{sp:{x:211856.47200,y:291786.05800},tp:{x:107.88630,y:32.54255}}];
	...
	this.param2UTM = {
		...
		D : 7.471885571721941*/
		A:1.437439233309315e+31,
		B:-6.285584726771798e+32,
		C:1.1975853001884053e+35,
		D:-1.3032783115991533e+37
	};
	...
	this.param2OCN = {
		...
		C : 2.65194218377714,
		D : -19.81500853970647*/
		A:6.956815820991407e-32,
		B:43.72765527138799,
		C:8.35013589297296e-36,
		D:108.82551008217287,
	};
	...
	//新增方法：OCN东南方向、西北方向互相转换
	this.OCN2OCN = function(ox,oy){
        //采点换取东南、西北方向两个地图的中心点坐标
		/*var a1 = {x:211381.52200,y:290228.36200};
		var b1 = {x:212961.30350,y:287971.68850};
		中心点：212171.41275  289100.02525
		var a2 = {x:212003.70350,y:291394.94050};
		var b2 = {x:212340.38908,y:286804.47109};
		中心点：212172.04629  289099.705795
		var a3 = {x:211435.22950,y:290728.61850};
		var b3 = {x:212908.97786,y:287471.87107};
		中心点：212172.10368  289100.244785
		var a3 = {x:212056.95700,y:289703.63200};
		var b3 = {x:212287.76786,y:288494.96107};
		中心点：212172.36243 289099.296535 
                       平均中心点：212171.9812875  28999.81854125*/
		var center = {x:212171.98128,y:289099.81854};
		var x,y;
		if(typeof ox != undefined && typeof oy != undefined ){
			//根据两点之间的的中心点公式：x = (x1 + x2)/2;y = (y1 + y2)/2;
			x = Number(center.x) * 2 - Number( ox );
			y = Number(center.y) * 2 - Number( oy );
		}
		return {x: x,y: y};
	}
	//UTM 《-》 WGS84 
